...
class PopularVegetebales extends StatefulWidget {
  const PopularVegetebales({super.key});

  @override
  State<PopularVegetebales> createState() => _PopularVegetebalesState();
}

class _PopularVegetebalesState extends State<PopularVegetebales> {
  List cartItems = [];
  ...
  Widget build(BuildContext context) {
    List pages = [
      const PopularVegetebales(),
      const LowPriceVegetables(),
      const AllVegetables(),
